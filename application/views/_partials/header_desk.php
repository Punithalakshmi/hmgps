                      ...
                      <div class="sec-4 clearfix"> 
                        ...
                        <div class="sec-6"> 
                            ...
                            <div id="popover-content" class="hide">
                                ...
                                <textarea class="form-control" id="guest_address" name="guest_address" placeholder="Enter Address"><?php //echo (isset($manual_address) && !empty($manual_address))?$manual_address:""; ?></textarea>
