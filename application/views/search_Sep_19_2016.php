...
function trackuser(uid='',sid='',cid='')
{
    ...
    var already_tracked = tracker_details("trackeduser");
       ...
       else
       {
           $("input[type='checkbox']").prop( "checked", function( i, val ) {
                  ...
                  var uid = (uid=='')?$(".track_userr").attr("data-uid"):uid;
                  var sid = (sid=='')?$(".track_userr").attr("data-mapsearch"):sid;
                  var cid = (cid=='')?$(".track_userr").attr("data-chid"):cid;
...
function breadcrumb()
{
    var user_id = $(".breadcrumb").attr("data-uid");

        $.post('<?php echo site_url();?>/home/breadcrumb/', {user_id:user_id}, function(response){
